...
\simpleheader{headercolour}{Jared}{Holland}{Mechanical Engineer: Sylva, North Carolina 28779}{white}
    ...
    \begin{tabular}{r| p{0.5\textwidth} c}
        \cvevent{2019--2023}{Bachelors In Mechanical Engineering}{Western Carolina University}{Cullowhee, NC \color{cvred}}{
            ...
            \begin{itemize}
                ...
                \item Basic understanding of Computational Fluid Dynamics (CFD) analysis using Ansys software.
