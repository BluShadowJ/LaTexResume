    ...
    \begin{tabular}{r| p{0.5\textwidth} c}
        \cvevent{2025--Present}{Masters in Engineering Technology}{Western Carolina University}{Cullowhee, NC \color{cvred}}{
            ...
            \begin{itemize}
                ...
                \item ET 572 - Finite Element Analysis 
                \begin{itemize}
                    \item Demonstrated proficiency using Abaqus: FEA
                    \item Simulated snap joints, structural components, and learned where to find online resources for non-linear material properties.
                \end{itemize}
            \end{itemize}
        }\\
