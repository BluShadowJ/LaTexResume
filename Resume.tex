...
\begin{tabular}{r| p{0.5\textwidth} c}
     \cvevent{2024--Present}{Western Carolina University}{Technical Support Technician}{Cullowhee, NC \color{cvred}}{
         \begin{itemize}
             \item Writes and verifies Majors and Degrees created using Degreeworks products from Ellucian.
             \item Designs, debugs, and maintains SQL reports vital to WCU's day to day operations.
             \item Preforms course substitutions and waiver requests from all the departments at WCU.
             \item Provides customer service to student and faculty regarding information or assitance in registrar related services.
             \item Optimizes programs and uses WCU's large amounts of student data to help test new tools designed for the university registrar system.     
         \end{itemize}
     } \\
...
\section*{Education}
    \begin{tabular}{r| p{0.5\textwidth} c}
        \cvevent{2025--Present}{Masters in Engineering Technology}{Western Carolina University}{Cullowhee, NC \color{cvred}}{
            \newline
            \textbf{Class Experiences}
            \begin{itemize}
                \item ET 593 - Operations Research
                \begin{itemize}
                    \item Learned key skills in optimizing prodcution environments
                \end{itemize}
                \item ET 572 - Finite Element Analysis 
                \begin{itemize}
                    \item Demonstrated profeciency using Abaqus: FEA
                    \item Simulated snap joints, structutral components, and learned where to find online resources for non-linear materials.
                \end{itemize}
            \end{itemize}
        }\\
