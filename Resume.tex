...
\usepackage[margin = 0.5cm, letterpaper]{geometry}%margin=1cm
\usepackage{hyperref}
\usepackage{fancyhdr}
\geometry{letterpaper, portrait, margin=0.5cm}
%------------------------------------------------------------------ Variablen
...
\begin{tabular}{r| p{0.5\textwidth} c}
     \cvevent{2024--Present}{Western Carolina University}{Technical Support Technician}{Cullowhee, NC \color{cvred}}{
         \begin{itemize}
             \item Writes and verifies Majors and Degrees created using Degree-works products from Ellucian.
             \item Designs, debugs, and maintains SQL reports vital to WCU's daily operations.
             \item Preforms course substitutions and waiver requests from all the departments at WCU.
             \item Provides customer service to students and faculty regarding information or assistance in registrar-related services.
             \item Optimizes programs and uses WCU's large amount of student data to help test new tools designed for the university registrar system.     
         \end{itemize}
     } \\
    ...
    \cvevent{2019--2023}{TekTone: Sound \& Signal}{Mechanical Engineering Intern}{Franklin, NC \color{cvred}}{
        \begin{itemize}
            \item Led the design of mechanical components for two anti-vandal nurse call stations, overseeing the entire life-cycle from conceptualization to successful product launch. 
            ...
            and MATLAB/Octave to produce high-quality graphs and figures organized in \LaTeX{} for presentation to management and interested parties.
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5
...
\section*{Education}
    \begin{tabular}{r| p{0.5\textwidth} c}
        \cvevent{2025--Present}{Masters in Engineering Technology}{Western Carolina University}{Cullowhee, NC \color{cvred}}{
            \newline
            \textbf{Notable Class Experience}
            \begin{itemize}
                \item ET 593 - Operations Research
                \begin{itemize}
                    \item Learned various techniques in managing efficient assembly lines using data analysis techniques.
                    \item Practiced experience from team based projects we were taught how to manage and led a team to ensure project deadlines were met.
                    \item Cemented the importance of gathering useful data, testing, and iterating on simulation models to help aid in making strategic decisions.
                \end{itemize}
            \end{itemize}
        }\\
...
%         \hline
%         R Studio & Octave & MATLAB & SQL\\
%         \hline
%         3D Printing & Maximo & Water Jet Cutting & Product Development\\
%         \hline
%         Mechanical Drawings & TOAD Oracle & KiCAD & Circuit Board Manufacturing\\
%        \hline
%    \end{tabular}
